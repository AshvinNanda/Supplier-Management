...
public class FirebaseDBHelper {
    ...
    public void automatedSchedule(final dataStatus ds) {
        ...
        FirebaseDatabase firebaseDB2 = FirebaseDatabase.getInstance();
        DatabaseReference ref3 = firebaseDB2.getReference("Order/");
        DatabaseReference ref4 = firebaseDB2.getReference("Supplier/");
        ...
        ref3.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                schedules.clear();
                for(DataSnapshot keyNode : dataSnapshot.getChildren()) {
                    orderDB order = keyNode.getValue(orderDB.class);
                    supplierDB supplier = keyNode.getValue(supplierDB.class);
